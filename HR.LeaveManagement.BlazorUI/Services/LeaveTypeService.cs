...
public class LeaveTypeService : BaseHttpService, ILeaveTypeService
{
    ...
    public async Task<Response<Guid>> CreateLeaveType(LeaveTypeVM leaveType)
    {
        try
        {
            ...
            await _client.CreateLeaveTypeAsync(createLeaveTypeCommand);
    ...
    {
        var leaveTypes = await _client.GetAllAll2Async();
    ...
    public async Task<Response<Guid>> UpdateLeaveType(int id, LeaveTypeVM leaveType)
    {
        try
        {
            ...
            await _client.UpdateLeaveTypeAsync(updateLeaveTypeCommand);
            return new Response<Guid>
            {
                Success = true
            };
